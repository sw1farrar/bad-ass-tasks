          ...
          <li key={file.id} className={cn(isSelected && "bg-[#c084fc]/5")}>
            <div className="px-3 py-3 flex gap-2 items-start">
              ...
              <button
                ...
                className="shrink-0 min-h-[40px] px-3 rounded-xl bg-[#c084fc]/15 border border-[#c084fc]/35 text-[#e9d5ff] text-xs font-semibold hover:bg-[#c084fc]/25 flex items-center gap-1.5"
              >
