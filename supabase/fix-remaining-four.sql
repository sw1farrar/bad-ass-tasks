-- ============================================
-- Second pass — re-apply the 4 most common stragglers
-- Run in Supabase SQL Editor. Safe to re-run.
-- If errors appear, note the line and paste back.
-- ============================================

-- A) Realtime for lists (run as standalone statements, not DO block)
ALTER PUBLICATION supabase_realtime ADD TABLE public.workspace_lists;
ALTER PUBLICATION supabase_realtime ADD TABLE public.list_items;

-- B) Dual-auth RPC (critical for sign-in)
...
-- E) Email columns (in case any were skipped)
ALTER TABLE notes
