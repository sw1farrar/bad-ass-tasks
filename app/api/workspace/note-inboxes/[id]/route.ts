...
import {
  deleteWorkspaceNoteInbox,
  updateWorkspaceNoteInbox,
...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    const inbox = await updateWorkspaceNoteInbox({
      inboxId: id,
      workspaceId,
      userId: user.id,
...
export async function DELETE(request: Request, context: RouteContext) {
  ...
  try {
    await deleteWorkspaceNoteInbox({ inboxId: id, workspaceId, userId: user.id });
