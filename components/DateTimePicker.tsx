    ...
    <div className={cn('px-1 pb-2', className)} style={style} {...rest}>
      <div className="flex items-center gap-1">
        <button
          ...
          className="h-9 w-9 shrink-0 rounded-lg text-text-secondary hover:text-text-primary hover:bg-surface-hover transition"
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 min-h-0">
        <DayPicker
          ...
          classNames={{
            ...
            weekday:
              'text-text-muted text-[9px] font-mono uppercase tracking-wider text-center py-1',
            week: 'grid grid-cols-7',
            day: 'flex items-center justify-center p-0',
            day_button:
              'h-9 w-9 max-sm:h-10 max-sm:w-10 flex items-center justify-center text-[13px] rounded-lg hover:bg-surface-hover active:scale-95 text-text-primary transition cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-purple/50',
            selected:
              '[&>button]:bg-neon-purple [&>button]:text-accent-on [&>button]:font-semibold',
            today:
              '[&>button]:ring-1 [&>button]:ring-neon-purple/50 [&>button]:text-neon-purple',
